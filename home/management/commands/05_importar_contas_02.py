...
for _, row in df.iterrows():
    try:
        ...
        ContaMaisEspecificaPercentil.objects.create(
            ...
            icms_nacional = row['perc_itc_imp_cms_pc_nac'],
            ipva_nacional = row['perc_itc_imp_pva_pc_nac'],
            ...
            icms_regional = row['perc_itc_imp_cms_pc_faixa'],
            ipva_regional = row['perc_itc_imp_pva_pc_faixa'],         
            ...
            icms_estadual = row['perc_itc_imp_cms_pc_uf'],
            ipva_estadual = row['perc_itc_imp_pva_pc_uf'],
