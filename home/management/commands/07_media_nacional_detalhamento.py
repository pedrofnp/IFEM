...
from home.models import MediaNacionalReceita, MediaUfReceita, MediaPorteReceita
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        nac = pd.read_excel('base_datas/media_nacional_detalhamento.xlsx')
        uf = pd.read_excel('base_datas/media_uf_detalhamento.xlsx')
        porte = pd.read_excel('base_datas/media_porte_detalhamento.xlsx')
    

        for _, row in nac.iterrows():
            MediaNacionalReceita.objects.create(
                    ano_referencia= 2024,
        ...
        for _, row in porte.iterrows():
            MediaPorteReceita.objects.create(
                    ano_referencia= 2024,
                    porte = row['faixas'],
